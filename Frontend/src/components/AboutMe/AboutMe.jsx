...
const AboutMe = () => {
  ...
  const [refPhone, isVisiblePhone] = useOnScreen({
    root: null, // Observar la ventana de visualización (viewport)
    rootMargin: "0px", // Margen opcional
    threshold: 0.5, // 10% del elemento debe estar visible para considerarlo en la vista
  });
  ...
  return (
    <div className="p-2 md:p-10 bg-white">
      <div className="grid col-span-1 md:flex items-center mt-20 justify-center">
        <div
          ref={ref}
          className={classNames("animate__animated md:mr-4", {
        ...
        <div
          className={classNames(
            "animate__animated md:border-l-2 sm:pl-4 p-2 col-span-2 text-justify md:w-1/2 mt-10 md:mt-0",
            { animate__fadeIn: isVisible }
          )}
        >
          <p className="about-me-text">
            ¡Hola! Soy Andejecruher, un desarrollador Full Stack apasionado por
            la tecnología. Me encanta aprender y crecer constantemente en el
            campo del desarrollo web y las tecnologías emergentes.
          </p>
          <p className="mt-4 about-me-text">
            Siempre busco compartir mis conocimientos y experiencias con otros.
            Estoy enfocado en crear aplicaciones web eficientes y efectivas, y
      ...
      <div className="grid col-span-1 md:flex items-center justify-center mt-10">
        <div>
          <div className="md:flex items-center md:mb-4">
            <div
              className={classNames(
                "animate__animated flex items-center md:mr-8 mb-2 md:mb-0",
                {
                  animate__fadeInTopLeft: isVisiblePhone && !isMobile,
                  animate__fadeInDown: isVisiblePhone && isMobile,
                }
              )}
            >
              <a
            ...
            <div
              className={classNames(
                "animate__animated flex items-center md:mr-8 mb-2 md:mb-0",
                {
                  animate__fadeInTopRight: isVisiblePhone && !isMobile,
                  animate__fadeInDown: isVisiblePhone && isMobile,
                }
              )}
            >
          ...
          <div className="md:flex items-center" ref={refPhone}>
            <div
              className={classNames(
                ...
                {
                  animate__fadeInTopLeft: isVisiblePhone && !isMobile,
                  animate__fadeInUp: isVisiblePhone && isMobile,
                }
              )}
            >
              <a
                href="tel:+523223018570"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center"
              >
