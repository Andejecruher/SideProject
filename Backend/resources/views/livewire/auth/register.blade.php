<main>
    <title>{{ __('Volt Laravel Dashboard - Sign Up page') }}</title>
    <!-- Section -->
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            {{-- <p class="text-center"><a href="{{ route('dashboard') }}" class="text-gray-700"><i class="fas fa-angle-left me-2"></i> {{ __('Back to homepage') }}</a></p> --}}
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="password" type="password" placeholder="{{ __('Password') }}" class="form-control" id="password" required>
                                    </div>
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input wire:model.lazy="passwordConfirmation" type="password" placeholder="{{ __('Confirm Password') }}" class="form-control" id="confirm_password" required>
                                    </div>
                                </div>
                                <!-- End of Form -->
                        ...
                        <div class="mt-3 mb-4 text-center">
                            <span class="fw-normal">{{ __('or') }}</span>
                        </div>
