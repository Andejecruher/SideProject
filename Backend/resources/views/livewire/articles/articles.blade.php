<div>
        ...
        <div class="d-block mb-4 mb-md-0">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{__("Articles List")}}</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="table-settings mb-4">
        <div class="row justify-content-between align-items-center">
            <div class="col-9 col-lg-8 d-md-flex">
                <h2 class="h4">{{__("Articles List")}}</h2>
            </div>
            <div class="col-3 col-lg-4 d-flex justify-content-end">
                <a href="/articles/create" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
    ...
    <div class="card card-body shadow border-0 table-wrapper table-responsive">
        <livewire:articles.article-table />
    </div>
</div>